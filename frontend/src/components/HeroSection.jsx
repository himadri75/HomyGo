  ...
  return (
    <section className="relative overflow-hidden bg-blue-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        {/* Badge */}
        <div
          className={`inline-flex items-center px-4 py-2 border border-blue-300 dark:border-blue-800 bg-white dark:bg-gray-900 text-blue-800 dark:text-blue-200 text-sm font-medium mb-8 shadow-sm dark:shadow-blue-950/20 transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
        >
        ...
        {/* Heading */}
        <h1
          className={`text-4xl sm:text-5xl lg:text-7xl font-bold text-blue-900 dark:text-white leading-tight mb-6 transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
          Discover India{" "}
        ...
        {/* Subtitle */}
        <p
          className={`text-lg sm:text-xl text-blue-800 dark:text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
        ...
        {/* Buttons */}
        <div
          className={`flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
        ...
        {/* Trust note */}
        <p
          className={`text-sm text-blue-700 dark:text-gray-400 transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
        >
        ...
        {/* Image Showcase */}
        <div
          className={`mt-16 transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
        >
