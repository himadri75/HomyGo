    ...
    <div className="bg-white dark:bg-gray-900 border border-blue-200 dark:border-gray-800 shadow-md dark:shadow-black/20 hover:shadow-xl transition-all duration-300 mb-4 p-4 rounded-2xl">
      ...
      <div className="flex justify-between gap-6">
        ...
        <div className="flex gap-4 flex-1">
          ...
          {/* Image */}
          <div className="w-40 h-32 overflow-hidden shrink-0 rounded-lg">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <span
                  className={`px-3 py-0.5 text-xs border font-semibold rounded-full ${getStatusBadge(booking.status)}`}
                >
                  {booking.status}
                </span>
        ...
        <div className="flex flex-col justify-center gap-3 min-w-35">
          ...
          {/* View Details */}
          <button
            className="w-full px-3 py-2 bg-blue-600 dark:bg-blue-500 text-white text-sm font-medium hover:bg-blue-700 dark:hover:bg-blue-400 transition rounded-lg"
            onClick={() =>
          ...
          {!["DONE", "CONFIRMED", "CANCELED"].includes(booking.status) && (
            <button
              ...
              className="w-full px-3 py-2 bg-red-100 dark:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-900/30 text-sm font-medium hover:bg-red-200 dark:hover:bg-red-900/40 transition rounded-lg"
            >
              Cancel
            </button>
          )}
